...
INSERT INTO Property (name, min_guests, max_guests, description, latitude, longitude, approved, pricing_mode, cancellation_deadline, auto_approve_enabled, street, city, country) VALUES ('City Apartment', 1, 2, 'Modern apartment in the heart of the city', 34.0522, -118.2437, false, 0, 14, false, 'Trg Dositeja Obradovica 6', 'Novi Sad', 'Serbia');
...
INSERT INTO Property (name, min_guests, max_guests, description, latitude, longitude, approved, pricing_mode, cancellation_deadline, auto_approve_enabled, street, city, country) VALUES ('Luxury Villa', 10, 20, 'Opulent villa with all amenities', 41.8781, -87.6298, false, 0, 14, false, 'Trg Dositeja Obradovica 6', 'Novi Sad', 'Serbia');
